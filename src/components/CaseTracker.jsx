    ...
    return (
        <div className="card">
            <div className="flex items-start justify-between gap-4">
                <div>
                    <div className="text-sm text-gray-500">Expediente</div>
                    <div className="font-bold text-lg">{c.id} · {c.product}</div>
                    <div className="text-sm text-gray-600">Canal: <b className="uppercase">{c.channel}</b> · Owner: <b>{c.owner}</b></div>
                </div>
            ...
            <div className="mt-6 grid md:grid-cols-2 gap-4">
                ...
                <div className="p-4 bg-gray-50 rounded-xl">
                    ...
                    <div className="text-sm text-gray-600">TTA estimado: <b>{c.ttaHours ?? 8}h</b></div>
            ...
            {ap && (
                <div className="mt-6 p-4 bg-gray-50 rounded-xl">
                    ...
                    <div className="text-xs text-gray-500 mt-1">
                        Dirección: {ap.address} · Ingresos: Q{ap.income}{ap.businessName ? ` · Negocio: ${ap.businessName}` : ''}
                    </div>
                </div>
            )}
        </div>
